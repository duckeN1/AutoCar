...
class HUD(object):
    ...
    def tick(self, world, clock):
        ...
        hitrosti.append((3.6 * math.sqrt(v.x**2 + v.y**2 + v.z**2)))
        zavora.append(c.brake)
        volan.append(c.steer)
...
def game_loop(args):
    ...
    try:
        ...
        f.create_dataset('hitrosti', data=hitrosti)
        f.create_dataset('zavora', data=zavora)
        f.create_dataset('volan', data=volan)
